...
const Pao = () => {
    ...
    useEffect(() => {
        // Fetch 
        const fetchPaoData = async () => {
            try {
                const docRef = doc(db, 'pastry', '3'); // Assuming '2' is the document ID for the pastry
        ...
        fetchPaoData(); // Call the function to fetch data
    }, []);
    ...
    return (
        <View style={styles.container}>
            <Image style={styles.bgImg} source={require('../assets/pao2.png')} />
