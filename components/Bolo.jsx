...
const Bolo = () => {
    ...
    useEffect(() => {
        // Fetch 
        const fetchBoloData = async () => {
            try {
                const docRef = doc(db, 'pastry', '2'); // Assuming '2' is the document ID for the pastry
        ...
        fetchBoloData(); // Call the function to fetch data
    }, []);
    ...
    const addToCart = async () => {
        try {
            console.log("Pastry Data:", pastryData);
            // Check if pastryData is properly initialized
            if (!pastryData) {
                console.log("pastry data is not yet loaded");
                return; // Exit early if pastryData is not initialized
            }
    ...
    return (
        <View style={styles.container}>
            <Image style={styles.bgImg} source={require('../assets/arroz2.png')} />
            ...
            <View style={styles.menu}>
                ...
                <TouchableOpacity style={styles.but} onPress={() => addToCart()}>
