...
const Cappuccino = () => {
    ...
    useEffect(() => {
        // Fetch "Cappuccino" coffee data from Firestore
        const fetchCappuccinoData = async () => {
            try {
                const docRef = doc(db, 'coffees', '3'); // Assuming '3' is the document ID for the "Cappuccino" coffee
        ...
        fetchCappuccinoData(); // Call the function to fetch data
    }, []);
    ...
    return (
        <View style={styles.container}>
            <Image style={styles.bgImg} source={require('../assets/cappuccino2.png')} />
