...
import ModalMilkshake from './ModalMilkshake'; // Assuming ModalMilkshake component is correctly implemented
...
const Milkshake = () => {
    ...
    useEffect(() => {
        const fetchDrinkData = async () => {
            try {
                const docRef = doc(db, 'drinks', '5'); // Fetch drink data with id 5
    ...
    const toggleSwitch = async () => {
        try {
            ...
            const docRef = doc(db, 'drinks', '5'); // Update document with id 5
    ...
    const addToCart = async () => {
        try {
            ...
            // Check if drinkData is properly initialized
            if (!drinkData) {
                console.log("drink data is not yet loaded");
                return; // Exit early if drinkData is not initialized
            }
    ...
    return (
        <View style={styles.container}>
            <Image style={styles.bgImg} source={require('../assets/milkshake2.png')} />
            ...
            <View style={styles.menu}>
                ...
                <View style={styles.typeBg}>
                    <Text style={styles.type}>Choose type of Milkshake</Text>
                    <ModalMilkshake onSelect={handleSelectMilk}/>
                </View>
                <View style={styles.obsBg}>
                    <TextInput onChangeText={setText} value={text} placeholder="Add Observations" style={styles.obs} />
                </View>
                <Image source={require('../assets/milkshakeCount.png')} style={styles.cof} />
