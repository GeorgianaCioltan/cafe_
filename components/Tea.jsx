...
const Tea = () => {
    ...
    return (
        <View style={styles.container}>
            <Image style={styles.bgImg} source={require('../assets/tea2.png')} />
            ...
            <View style={styles.menu}>
                ...
                <View style={styles.typeBg}>
                    <Text style={styles.type}>Choose type of Tea</Text>
                    <ModalTea onSelect={handleSelectMilk}/>
                </View>
                <View style={styles.obsBg}>
                    <TextInput onChangeText={setText} value={text} placeholder="Add Observations" style={styles.obs} />
                </View>
                <Image source={require('../assets/teaCount.png')} style={styles.cof} />
