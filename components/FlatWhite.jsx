...
const FlatWhite = () => {
    ...
    useEffect(() => {
        // Fetch "Flat White" coffee data from Firestore
        const fetchFlatWhiteData = async () => {
            try {
                const docRef = doc(db, 'coffees', '7'); // Assuming '7' is the document ID for the "Flat White" coffee
        ...
        fetchFlatWhiteData(); // Call the function to fetch data
    }, []);
    ...
    return (
        <View style={styles.container}>
            <Image style={styles.bgImg} source={require('../assets/flat-white2.png')} />
