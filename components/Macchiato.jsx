...
const Macchiato = () => {
    ...
    useEffect(() => {
        // Fetch "Macchiato" coffee data from Firestore
        const fetchMacchiatoData = async () => {
            try {
                const docRef = doc(db, 'coffees', '6'); // Assuming '6' is the document ID for the "Macchiato" coffee
        ...
        fetchMacchiatoData(); // Call the function to fetch data
    }, []);
    ...
    const toggleSwitch = async () => {
        try {
            ...
            const docRef = doc(db, 'coffees', '6'); // Assuming '5' is the document ID for the "Americano" coffee
    ...
    return (
        <View style={styles.container}>
            <Image style={styles.bgImg} source={require('../assets/macchiato2.png')} />
            ...
            <View style={styles.menu}>
                ...
                <View style={styles.typeBg}>
                    <Text style={styles.type}>Choose type of milk</Text>
                    <Modaltest onSelect={handleSelectMilk}/>
                </View>
